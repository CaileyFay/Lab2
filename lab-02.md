...
2.2 Color and fill are aesthetics, but alpha is part of geom_density
because of the way that the layering occurs to make the graph. The
density part is adding on to the plot, and the alpha is directly related
to the “see-through-ness” of this new addition.
